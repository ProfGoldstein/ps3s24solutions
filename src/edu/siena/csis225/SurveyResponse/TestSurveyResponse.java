package edu.siena.csis225.SurveyResponse;
...
public class TestSurveyResponse {
    ...
    /**
     * The main method to test the SurveyResponse class.
     *
     * @param args Does not use arguments
     */
    public static void main(String[] args) {

        /*
         * test cases for PS3 part1 SurveyResponse
         *
         */

        // Create a list of testResponses
        List<SurveyResponse> testResponses = new ArrayList<>();
        testResponses.add(new SurveyResponse(123, "MATH", 1, "Never again!"));
        testResponses.add(new SurveyResponse(456, "MATH", 5, "Good"));
        testResponses.add(new SurveyResponse(789, "MATH", 4, "Fun"));
        testResponses.add(new SurveyResponse(246, "ART", 2));
        ...
        System.out.println("Expecting ten lines of output. Fourth comment should be blank");
