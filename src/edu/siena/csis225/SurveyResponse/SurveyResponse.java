 ...
 * 
 * Since the classes are all in the same package, we set the variables to
 * default, which allows access from the same class and the same package.
 * Setting it to protected would then also allow access from different
 * package subclass.
 */
